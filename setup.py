...
setup(
    ...
    name="MusicLibraryConverter",  # Required
    ...
    description="A tool for converting large amounts of files from flac to ogg vorbis or mp3 including tags, based on ffmpeg",  # Optional
    ...
    #url="https://github.com/pypa/musiclibraryconverter",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Eike M. Thaden",  # Optional
    ...
    keywords="converter ogg vorbis mp3 ffmpeg tags",  # Optional
    ...
    install_requires=["mutagen==1.45.1", "psutil==5.8.0"],  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/ethaden/MusicLibraryConverter/issues/",
        "Source": "https://github.com/ethaden/MusicLibraryConverter/",
    },
)
